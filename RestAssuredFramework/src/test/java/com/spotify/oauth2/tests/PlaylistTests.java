...
public class PlaylistTests extends _BaseTest {
    ...
    @FrameworkAnnotation(author = { AuthorType.A, AuthorType.ABC},
    ...
    @FrameworkAnnotation(author = { AuthorType.AB, AuthorType.ABCD}, 
    ...
    @Story("Create a playlist story")
    @FrameworkAnnotation(author = { AuthorType.ABC, AuthorType.AB}, 
	category = { CategoryType.BVT,CategoryType.REGRESSION })
    @Test(groups = {"BVT","REGRESSION"})
